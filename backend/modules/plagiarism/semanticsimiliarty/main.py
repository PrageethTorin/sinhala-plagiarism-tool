...
# When this app is started from the repo root (e.g. uvicorn backend.semanticsimiliarty.main:app),
# we still want `from modules...` imports to resolve to backend/semanticsimiliarty/modules.
